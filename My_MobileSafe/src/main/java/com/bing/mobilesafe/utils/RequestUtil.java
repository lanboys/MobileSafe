package com.bing.mobilesafe.utils;
...
public class RequestUtil {
    ...
    private static void loadImageByRequest(final Context context, final Handler handler, final ImageView img_pic, String url, final CallBackListner<Bitmap> listner) {
        ...
        ImageRequest imageRequest = new ImageRequest(url, new Response.Listener<Bitmap>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //TODO 打印日志
                Log.v("-->mobile", "RequestUtil.onErrorResponse():68:: " + error.getLocalizedMessage());
                img_pic.setImageResource(R.drawable.default_icon);
            }
        });
    ...
    public static void loadImageByImageLoader(Context context, final ImageView img_pic, String url) {
        ...
        ImageListener listener = ImageLoader.getImageListener(img_pic, R.drawable.default_icon, R.drawable.default_icon);
